...
class ConfusionMatrix(object):
    ...
    def compute_mat_by_step(self, steps=0.01):
        pass

    def compute_mat_by_percentile(self):
        pass
...
class BiClassMetric(object):
    ...
    @staticmethod
    def prepare_confusion_mat(labels, scores, add_to_end=True):
    ...
    def compute(self, labels, scores):
        confusion_mat, score_threshold, cuts = BiClassMetric.prepare_confusion_mat(labels, scores)
...
class BiClassPrecision(BiClassMetric):
    ...
    def compute_metric_from_confusion_mat(self, confusion_mat):
